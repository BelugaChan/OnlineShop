...
namespace api.Migrations
{
    ...
    [Migration("20240410175232_InheritanceAndManyToMany")]
    partial class InheritanceAndManyToMany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "126d4268-ea41-4dab-af6a-5d80409fe411",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "9c110bc8-d87a-45ca-8590-9524f19486ba",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Lamps", b =>
                {
                    b.HasOne("api.Models.Product", null)
                        .WithOne()
                        .HasForeignKey("api.Models.Lamps", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
